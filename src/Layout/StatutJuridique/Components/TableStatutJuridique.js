...
function TableStatutJuridique(props) {
    ...
    const handleEdit = (id) => {
        ...
        alert(intid)
        setTypesId(intid)
        const newurl = process.env.REACT_APP_URL_STANDART + `/typeEvenements/${intid}`
    ...
    const FormEdit = (e) => {
        ...
        const newurl = process.env.REACT_APP_URL_STANDART + `/typeEvenements/${typesId}`
    ...
    const Form = (e) => {
        ...
        const newurl = process.env.REACT_APP_URL_STANDART + "/typeEvenements"
    ...
    return (
        <>
            <div className="p-4 sm:ml-64">
                <Titre titre="Liste des statuts juridiques" />
                <div className='pb-4'>
                    <Button color='' className='bg-amber-600 hover:bg-amber-700 text-white' onClick={() => setOpenModal(true)}>Ajouter un statut juridique</Button>
                        ...
                        <Modal.Body>
                            <form onSubmit={Form}>
                                <div className="space-y-6">
                                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">Remplissez les champs et validez pour créer un statut juridique</h3>
                                    <div>
                                        <div className="mb-2 block">
                                            <Label htmlFor="code" value="Code statut juridique" />
                                        </div>
                                        <TextInput onChange={(e) => setTypeCode(e.target.value)} value={typeCode} id="code" required />
                                    </div>
                                    <div>
                                        <div className="mb-2 block">
                                            <Label htmlFor="libelle" value="Libellé statut juridique" />
                                        </div>
                    ...
                    <Modal show={openEditModal} size="md" popup onClose={() => handleCloseEditModal()}>
                        ...
                        <Modal.Body>
                            <form onSubmit={FormEdit}>
                                <div className="space-y-6">
                                    <h3 className="text-xl font-medium text-gray-900 dark:text-white">Modifier un statut juridique</h3>
                                    <div>
                                        <div className="mb-2 block">
                                            <Label htmlFor="code" value="Code statut juridique" />
                                        </div>
...
export default TableStatutJuridique;